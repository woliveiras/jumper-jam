...
/** @type {string} */
const CACHE_VERSION = '1744796757|92190040545';
/** @type {string} */
const CACHE_PREFIX = 'Jumper Jam-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Jumper Jam.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Jumper Jam.html","Jumper Jam.js","Jumper Jam.offline.html","Jumper Jam.icon.png","Jumper Jam.apple-touch-icon.png","Jumper Jam.audio.worklet.js","Jumper Jam.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Jumper Jam.wasm","Jumper Jam.pck"];
